...
namespace ExportExcelReport
{
    public class Excel
    {
        ...
        public void SaveFile()
        {
            ...
            {
                file_name = DateTime.Now.ToString("yyyyMMddHHmmss") + ".xlsx";
            }

            //            DocumentFormat.OpenXml.Spreadsheet.Workbook

            using (SpreadsheetDocument spreadSheet = SpreadsheetDocument.Open(file_name, true))
            {
        ...
        public static void ResponseSpreadsheetWorkbook(Stream stream)
        {
            // Create a spreadsheet document by supplying the filepath.
            // By default, AutoSave = true, Editable = true, and Type = xlsx.
